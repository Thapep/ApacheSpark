Ερώτημα Q1: Ουσιαστικά εδω πέρα θα δώσουμε σαν εισοδο στην διαδικασία map μια γραμμή του csv, η οποία στη συνέχεια θα δώσει σαν έξοδο μια τούπλα της οποίας το πρώτο στοιχείο θα είναι η χρονιά ώστε να ομαδοποιηθούν οι ταινίες με την ιδια χρονιά στην ίδια reduce διαδικασία, και το δευτερο στοιχείο θα είναι μια τούπλα με το όνοαμ της ταινίας και το κέρδος σύμφωνα με τον ρισμό που μας εχει δωθεί. Τέλος, η διαδικασία reduceByKey ιθα ομαδοποιήσει τα ταινιες ανα χρονιά και θα εξάγει την ταινία με το μέγιστο κέρδος. 
