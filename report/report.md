...
Η συμπλήρωση στον κώδικα που κάναμε ώστε να απενεργοποιηθεί ο βελτιστοποιητής είναι οτί προσθέσαμε το configuration `spark.sql.autoBroadcastJoinThreshold`  με τιμή `-1` ώστε όποιο και να είναι το μέγεθος του αρχείου να μη γίνει broadcast.
